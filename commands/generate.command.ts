...
import { WatsonCollection } from '../lib/schematics/watson.collection';
...
export class GenerateCommand extends AbstractCommand {
    ...
    program
      ...
      .action(
        async (
          ...
          options.push({
            name: "collection",
            value: command.collection || Collection.WATSONJS,
          });
          options.push({
            name: "project",
  ...
  private buildSchematicsListAsTable(): string {
    ...
    for (const schematic of WatsonCollection.getSchematics()) {
      table.push([
