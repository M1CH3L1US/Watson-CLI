...
import { askForProjectName, moveDefaultProjectToStart, shouldAskForProject } from '../lib/utils/project-utils';
import { AbstractAction } from './abstract.action';

const schematicName = "watson-add";
...
export class AddAction extends AbstractAction {
  public async handle(inputs: Input[], options: Input[], extraFlags: string[]) {
    ...
    if (packageInstallSuccess) {
      ...
      console.error(
        chalk.red(MESSAGES.LIBRARY_INSTALLATION_FAILED_BAD_PACKAGE(libraryName))
      );
    }
  }
