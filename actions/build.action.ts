...
import { ConfigurationLoader, WatsonConfigurationLoader } from '../lib/configuration';
...
export class BuildAction extends AbstractAction {
  ...
  protected readonly loader: ConfigurationLoader = new WatsonConfigurationLoader(
